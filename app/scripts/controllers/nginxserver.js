define(['angular'], function (angular) {
  ...
  /**
   * @ngdoc function
   * @name zCloudApp.controller:NginxServerCtrl
   * @description
   * # NginxServerCtrl
   * Controller of the zCloudApp
   */
  angular.module('zCloudApp.controllers.NginxServerCtrl', ['highcharts-ng'])
    .controller('NginxServerCtrl', function (NginxService, $scope, $state, $modal) {
      this.awesomeThings = [
        'HTML5 Boilerplate',
        'AngularJS',
        'Karma'
        ...
        $scope.initPage = function(searchKey){
            NginxService.fetch({page: $scope.page, pageSize: $scope.pageSize, searchKey:searchKey}).
